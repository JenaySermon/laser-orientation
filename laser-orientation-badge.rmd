...
-   i wonder what the various courses are, they seem very different.

-   The points possible are also all over the place, which makes me
    question what the data set is capturing.
...
```{r}
d |> 
  select(student_id, total_points_possible, total_points_earned, semester)
```
...
-   there are more rows; from 438 to 495 rows
